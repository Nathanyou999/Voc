...
def build_insert_alarm_query():
    ...
    INSERT INTO [ods_voc_script_Processdata_realtime] (
        ...
        [RTO转阀伺服电机驱动报警],
        [RTO转阀伺服电机冷却电机故障],
        [MV3012_RTO 处理阀开不到位报警],
        [MV3012_RTO 处理阀关不到位报警],
        [AV3011_RTO 直排阀开不到位报警],
        [AV3011_RTO 直排阀关不到位报警],
        [MV3010_RTO 新风阀开不到位报警],
        [MV3010_RTO 新风阀关不到位报警],
        [AV3017_ 助燃风阀开不到位报警],
        [AV3017_ 助燃风阀关不到位报警],
        [MV3015_ 旋转RTO反吹阀开不到位报警],
        [MV3015_ 旋转RTO反吹阀关不到位报警],
        [CV3016_RTO 高温比例阀报警],
        [RTO燃烧机本地模式开启],
        [RTO燃烧机熄火故障报警],
        [RTO燃烧机燃气高压故障报警],
        ...
        [转轮过滤箱三级压差报警],
        [转轮过滤箱四级压差报警],
        [转轮过滤箱压差报警未处理超 4小时自动降温停机],
        [MV1012转轮进口阀执行器 A开不到位报警],
        [MV1012转轮进口阀执行器 A关不到位报警],
        [MV1010转轮新风阀执行器 A开不到位报警],
        [MV1010转轮新风阀执行器 A关不到位报警],
        [MV2013转轮风机出口阀执行器 A开不到位报警],
        [MV2013转轮风机出口阀执行器 A关不到位报警],
        [MV2016_ 换热器冷侧出口阀开不到位报警],
        [MV2016_ 换热器冷侧出口阀关不到位报警],
        [CV2012转轮脱附出口阀 A报警],
        [CV2015_ 换热器冷侧进口比例阀报警],
        [CV2014_ 换热器调温比例阀报警],
        [CV2017换热器热侧出口阀报警],
        [CV2010转轮冷却出口阀报警],
        [CV2011转轮脱附进口阀报警],
